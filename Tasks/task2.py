...
# Participants info 
participants_dir = os.path.join(os.path.dirname(__file__), "..", "Dataset")
...
data_dir = os.path.join(os.path.dirname(__file__),"..", "Dataset", "derivatives")
...
# Save the processed data to a CSV file for use in task 3
